    ...
    return (
      <SafeAreaView style={{ backgroundColor: "#e5f3ca" }}>
        <View style={([styles.MainContent], { backgroundColor: "#ffffff" })}>
            ...
            <View style={[styles.container, { backgroundColor: "#ffffff" }]}>
              ...
              >
                ...
                <Text style={styles1.paragraph}>
                  ...
                  <Text>
                    ...
                    your wellness. Students currently living in Ontario can
                    access the college’s remote medical care and mental health
                    supports to discuss any physical and mental health issues
              ...
              <View style={styles.scrollviewset}>
                ...
                >
                  ...
                  <View style={styles.viewset}>
                    ...
                    >
                      ...
                      <TouchableOpacity
                        onPress={() => {
                          this.props.navigation.navigate("MentalHealth");
                        }}
                      >
                        <View style={styles.imageview}>
                          <Image
                            source={require("../../assets/res/mental_health.png")}
                      ...
                      <Link to="/Medical_Care">
                        <View style={styles.imageview}>
                          <Image
                            source={require("../../assets/res/medical_care.png")}
                            style={styles.imageprop}
                          ></Image>
                        </View>
                      </Link>
                      <Link to="/Counselling">
                        <View style={styles.imageview}>
                          <Image
                            source={require("../../assets/res/counselling.png")}
                            style={styles.imageprop}
                          ></Image>
                        </View>
                      </Link>
                      <Link to="/HealthInsurance">
                        <View style={styles.imageview}>
                          <Image
                            source={require("../../assets/res/health_insurance.png")}
                            style={styles.imageprop}
                          ></Image>
                        </View>
                      </Link>
                      <Link to="/Related_service">
                        <View style={styles.imageview}>
                          <Image
                            source={require("../../assets/res/related_resources.png")}
                            style={styles.imageprop}
                          ></Image>
                        </View>
                      </Link>
                      <Link to="/Help_Student">
                        <View style={styles.imageview}>
                          <Image
                            source={require("../../assets/res/help_student.png")}
                            style={styles.imageprop}
                          ></Image>
                        </View>
                      </Link>
                      <Link to="/Contact">
                        <View style={styles.imageview1}>
                          <Image
                            source={require("../../assets/res/contact.png")}
                            style={[styles.imageprop, { marginRight: 20 }]}
                          ></Image>
                        </View>
                      </Link>
                    </ScrollView>
                ...
                >
                  ...
                  >
                    <Text style={styles.paraText1}>
                      Prescription medications/ renewals
                    </Text>
                  </Unorderedlist>
                  <View style={styles1.lineStyle}></View>
                  <Unorderedlist
          ...
          >
            <Image
              source={require("../../assets/res/bg1.jpg")}
              style={[
                styles1.HeaderInsideText,
                { height: AnimateHeaderHeight < 200 ? 0 : 180 },
              ]}
            />
          </Animated.View>
        </View>
