      ...
      <View style={style2.container}>
          ...
          >
            ...
            <View style={{ width: "100%" ,alignItems: 'center'  }}>
              ...
              <View style= {{borderTopColor:"black" ,borderTopWidth:2 , width:"100%" ,display:"flex",flexDirection:"column",alignItems:"center" }}>
                ...
                <Text style={[style2.paraText,{marginLeft:0,textAlign:"center" ,fontWeight: "bold", marginTop:10, color:"green" }]}>For more self-help ideas</Text>
        ...
        <View style={style2.outer}>
          ...
          >
            ...
            <View style={{ width: "100%" ,alignItems: 'center'  }}>
              <Text style={[style2.paraText,{textAlign:'center',fontWeight:'bold',fontSize:24,padding:80,alignContent:'center'}]}>What is Peer Support?</Text>
              <View style= {{borderTopColor:"black" ,borderTopWidth:2 , width:"100%" ,display:"flex",flexDirection:"column",alignItems:"center" }}>
        ...
        <View style={style2.outer}>
          ...
          >
            ...
            <View style={{ width: "100%", height:"100%",alignItems: 'center',display:'flex',justifyContent:'center',alignItems:'center'  }}>
            <Text style={[style2.paraText,{textAlign:'center',fontWeight:'bold',fontSize:24,alignContent:'Justify',alignItems:'center'}]}>Help A Student</Text>
        ...
        <View style={style2.outer}>
          ...
          >
            ...
            <View style={{ width: "100%", height:"100%",alignItems: 'center',display:'flex',justifyContent:'center',alignItems:'center'  }}>
            <Text style={[style2.paraText,{textAlign:'center',fontWeight:'bold',fontSize:24,alignContent:'Justify',alignItems:'center'}]}>Off-campus mental health supports for students</Text>
              
            </View>
            <View style={{ height: 450, width: "100%", marginTop:20 }}>    
                <Unorderedlist bulletUnicode={0x2022} style={{marginLeft:5}}>
                  <Text style={style2.paraText}>
                   <Text style={[style2.paraText],{color:'blue'}} onPress={()=>{Linking.openURL('https://www.conestogac.on.ca/onecard/');}}>Good2Talk</Text>
